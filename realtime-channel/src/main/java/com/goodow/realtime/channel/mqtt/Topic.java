...
/**
 * Created by larry on 2017/10/30.
 */
...
public class Topic implements Serializable {
  ...
  public List<Token> getTokens() {
    if (tokens == null) {
      try {
        ...
        valid = false;
        String[] params = {topic, e.getMessage()};
        LOG.log(Level.SEVERE, "Error parsing the topic: {}, message: {}", params);
      }
    }
  ...
  public Topic exceptHeadToken() {
    ...
    if (tokens.isEmpty()) {
      return new Topic(Collections.<Token>emptyList());
    }

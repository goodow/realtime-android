...
public class CloudEndpointUtils {
  ...
  /*
   * Need to change this to 'true' if you're running your backend locally using the DevAppServer.
   * See http://developers.google.com/eclipse/docs/cloud_endpoints for more information.
   */
   ...
   * Android's virtual router. See
   * http://developer.android.com/tools/devices/emulator.html#networkaddresses for more information.
   */
  public static final String LOCAL_APP_ENGINE_SERVER_URL_FOR_ANDROID = "http://10.0.2.2:8888";

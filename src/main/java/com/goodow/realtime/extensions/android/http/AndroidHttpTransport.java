 ...
 * 
 * <p>
 * Users should consider modifying the keep alive property on {@link AndroidHttpTransport} to
 * control whether the socket should be returned to a pool of connected sockets. More information is
 * available <a
 ...
 * </p>
 */
public final class AndroidHttpTransport extends HttpTransport {

  /**
   * Builder for {@link AndroidHttpTransport}.
   * 
   * <p>
  ...
  public static final class Builder {
    ...
    /** Returns a new instance of {@link AndroidHttpTransport} based on the options. */
    public AndroidHttpTransport build() {
      return new AndroidHttpTransport(proxy, sslSocketFactory, hostnameVerifier);
    }
    ...
    public Builder trustCertificatesFromStream(InputStream certificateStream)
      ...
      SecurityUtils.loadKeyStoreFromCertificates(trustStore, SecurityUtils
          .getX509CertificateFactory(), certificateStream);
      return trustCertificates(trustStore);
    }
  }
  ...
  private static final String[] SUPPORTED_METHODS = {
      HttpMethods.DELETE, HttpMethods.GET, HttpMethods.HEAD, HttpMethods.OPTIONS, HttpMethods.POST,
   ...
   */
  AndroidHttpTransport(Proxy proxy, SSLSocketFactory sslSocketFactory,
  ...
  @Override
  public AndroidHttpRequest buildRequest(String method, String url) {
    ...
    try {
      ...
      return new AndroidHttpRequest(connection);
    } catch (IOException e) {
